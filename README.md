...
### Running Enfobot Locally

You can test your hubot by running the following, however some plugins will not
behave as expected unless the [environment variables](#configuration) they rely
upon have been set.

You can start Enfobot locally by running:
...
Then you can interact with Enfobot by typing `Enfobot help`.

    Enfobot> Enfobot help
    Enfobot animate me <query> - The same thing as `image me`, except adds [snip]
    Enfobot help - Displays all of the help commands that Enfobot knows about.
    ...
