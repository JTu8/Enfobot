...
function getClient(table, callback) {
  ...
  var url = config.ROOT_URL + "/" + table + ".do?displayvalue=all&WSDL";
...
// Find details for user by users ID
function getUserByID(queryUser, callback) {
  return getRecordsWhere(
    "sys_user",
    {
      sys_id: queryUser
...
// Find details for user by users full name
function getUserName(queryUser, callback) {
  return getRecordsWhere (
    "sys_user",
    {
      name: queryUser
...
// Find details for group by groups ID
function getGroupByID(queryUser, callback) {
  return getRecordsWhere(
      "sys_user_group",
    {
      sys_id: queryUser
...
// Find details for group by groups name
function getGroupByName(queryUser, callback) {
  return getRecordsWhere(
      "sys_user_group",
    {
      name: queryUser
...
function getCommentByTask(queryUser, callback) {
  return getRecordsWhere(
    "sys_journal_field",
    {
      element_id: queryUser
    },
    function(err, results) {
      if (err) {
        callback(err);
...
module.exports = {
  ...
  getCommentByTask: getCommentByTask,
  config: config
};
